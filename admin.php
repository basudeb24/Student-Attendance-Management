  ...
  <div class="container ">
    <div class="row">
      <div class="col-md-6 offset-md-3">
        <h2 class="rainbow_text animated">Please Sign in</h2>
        <div class="card my-auto">
        <div class="Container">
          <form method="post" class="card-body ">

            <div >
              <img src="https://cdn-icons-png.flaticon.com/512/2206/2206248.png" class="img-fluid profile-image-pic img-thumbnail rounded-circle my-4"
            ...
            <!-- <div class="text-center"><button type="submit"  class="btn btn-primary" value="Login" name="submit">Login</button></div> -->
